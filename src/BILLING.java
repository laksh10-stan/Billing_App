...
public class BILLING extends javax.swing.JInternalFrame {
  ...
  Statement st=null,stDelete=null,stNew=null;
   ResultSet rs = null;
...
{ 
 ...
 pst.executeUpdate();
  ...
  {   
    ...
    String c = (String)jTable1.getValueAt(row, 1);
   String d = (String)jTable1.getValueAt(row, 2);
   String e = (String)jTable1.getValueAt(row, 3);
   String f = (String)jTable1.getValueAt(row, 4);
   String g = (String)jTable1.getValueAt(row, 5);
   String h = (String)jTable1.getValueAt(row, 6);
    String queryco = "Insert into Item_Sol(Bill_No,Item_No,Item_Name,Item_Make,Item_Srno,Unit_Price,Unit_Quantity,Total) values ('"+a+"','"+b+"','"+c+"','"+d+"','"+e+"','"+f+"','"+g+"','"+h+"')";
