  ...
  Statement st=null;
   ...
   public EditCustomer() throws SQLException, Exception {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Customer GStin_no");
        jLabel10.setName("jLabel10"); // NOI18N

        jLabel11.setFont(new java.awt.Font("Trebuchet MS", 0, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Other Contact");
        ...
        try {
            ...
            rs = st.executeQuery("select * from Customer_Master where Customer_name='"+NameVal+"'");
                 ...
                 rs.next();
                     ...
                     ctel.setText(""+rs.getString(6));
                     cd.setText(""+rs.getString(7));
                     ccst.setText(""+rs.getString(8));
                     ctin.setText(""+rs.getString(9));
